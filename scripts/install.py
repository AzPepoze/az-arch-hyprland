...
class InstallerApp(QWidget):
    ...
    def populate_install_items(self):
        ...
        self.installation_items = [
            ...
            {'type': 'optional', 'text': 'Install NVIDIA Drivers (Proprietary)', 'func': 'install_nvidia_drivers', 'group': 'Graphics', 'description': 'Installs NVIDIA drivers and utilities for better graphics performance.'},
            ...
            {'type': 'optional', 'text': 'Install npm', 'func': 'install_npm', 'group': 'Development Runtimes', 'description': 'Installs npm (Node Package Manager), a package manager for JavaScript.'},
            {'type': 'optional', 'text': 'Install pnpm', 'func': 'install_pnpm', 'group': 'Development Runtimes', 'description': 'Installs pnpm, a fast, disk-space efficient package manager for Node.js.'},
            ...
            {'type': 'essential', 'text': 'Install Discord', 'func': 'install_discord', 'group': 'Communication', 'description': 'Installs the official Discord client.'},
            {'type': 'optional', 'text': 'Install Vencord (Discord Mod)', 'func': 'install_vencord', 'group': 'Communication', 'description': 'Installs the Vencord mod for Discord.'},
            ...
            {'type': 'essential', 'text': 'Install Pavucontrol-Qt', 'func': 'install_pavucontrol', 'group': 'Audio', 'description': 'Installs Pavucontrol, a simple GTK based volume control tool for PulseAudio.'},
            ...
            {'type': 'optional', 'text': 'Install Virtualization (libvirt, virt-manager, QEMU)', 'func': 'install_virt_packages', 'group': 'Virtualization', 'description': 'Installs essential virtualization tools including libvirt, virt-manager, QEMU, dnsmasq, and dmidecode, and enables the libvirtd service.'},
            ...
            {'type': 'optional', 'text': 'Install v4l2loopback (for Droidcam/OBS)', 'func': 'install_v4l2loopback', 'group': 'Drivers & Modules', 'description': 'Installs v4l2loopback, a kernel module that creates virtual video devices, useful for Droidcam or OBS.'},
