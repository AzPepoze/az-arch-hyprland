...
class InstallerApp(QWidget):
    ...
    def populate_install_items(self):
        ...
        self.installation_items = [
            ...
            {'type': 'optional', 'text': 'Install Pavucontrol', 'func': 'install_pavucontrol', 'group': 'Audio', 'description': 'Installs Pavucontrol, a simple GTK based volume control tool for PulseAudio.'},
